...
# Setup
1. Create an object of the class EntityExtractor initialized with the desired LLM using LangChain.
2. Create an object of the class RelationsExtractor initialized with the desired LLM using LangChain.
3. Create an object of the class GraphBuilder.

# Pipeline
Listed is the minimal requirements for usage:
